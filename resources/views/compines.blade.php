...
<body class="g-sidenav-show  bg-gray-100">
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link  active" href="{{ url('compinespage') }}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        ...
                        <span class="nav-link-text ms-1">compines</span>
                    </a>
                </li>
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">compines</li>
                    </ol>
                    <h6 class="font-weight-bolder mb-0">compines</h6>
                </nav>

            </div>
        </nav>
        <!-- End Navbar -->
        <a href="{{ url('compines') }}"><button>create new copmany</button></a>
        <div class="container-fluid py-4">
            <div class="row">

                @if (session('sucssesdelete'))
                    <div>{{ session('sucssesdelete') }}</div>
                @endif
                @if (session('succsesupdate'))
                    <div>{{ session('succsesupdate') }}</div>
                @endif
                <div class="col-12">
                    <div class="card mb-4">
                                        ...
                                        @foreach ($compines as $company)
                                            <tr>
                                                ...
                                                <td class="align-middle text-center">
                                                    <span
                                                        class="text-secondary text-xs font-weight-bold">{{ $company->website }}</span>
                                                </td>
                                                <td class="align-middle text-center text-sm">
                                                    <form method="POST" action="{{ url('detailscompany') }}">
                                                ...
                                                <td id="{{ $company->id }}" class="align-middle">
                                                    <a href="javascript:;"
    ...
    <!-- Bootstrap Modal for Editing Company -->
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form id="editCompanyForm" method="POST" action="{{ url('updatecompany') }}"
    ...
    <script>
        $('#editCompanyModal').on('show.bs.modal', function(event) {
            ...
            var modal = $(this);
            modal.find('#company_id').val(companyId);
